...
def get_vehicle_parts():
    vehicle_items = {"1": ["bolted plates", "ARMOR", 0, 2, 2, 2, 1, "RIVETED",
                     ...
                     "59": ["machine gun", "WEAPON", 0, 2, 1, 1, 0, "QUICK",
                            "A bulky and slow firing machine gun from the last war."],
                     "60": ["improved machine gun", "WEAPON", 2, 6, 1, 1, 0, "RAPID",
                            "A simpler and faster firing machine gun."],
                     "61": ["heavy machine gun", "WEAPON", 3, 6, 1, 1, 1, "QUICK",
                     ...
                     "65": ["small gun", "WEAPON", 0, 2, 2, 1, 2, "",
                            "A small caliber gun, the equivalent of an infantry carried anti tank rifle."],
                     "66": ["improved small gun", "WEAPON", 2, 6, 2, 1, 2, "IMPROVED_GUN",
                     ...
                     "74": ["advanced heavy gun", "WEAPON", 5, 6, 8, 1, 9, "ADVANCED_GUN",
                     ...
                     "85": ["small rockets", "WEAPON", 3, 6, 2, 1, 6, "SMALL_ROCKETS",
                            "Rockets can deliver an intense barrage in a short space of time. Has a long reload time."],
                     "86": ["large rockets", "WEAPON", 4, 6, 4, 1, 15, "LARGE_ROCKETS",
...
def get_design_rules():
    design_rules = {"1": ["gun carriage", "GUN_CARRIAGE", 0, "This vehicle is actually a gun carriage."],
                    ...
                    "5": ["wheeled drive", "WHEELED", 0, "The vehicle has road wheels."],
                    "6": ["open top", "OPEN_TOP", 0,
                          "The vehicle has an open top or turret, can be damaged by grenades or artillery."],
                    "7": ["long chassis", "LONG_CHASSIS", 1,
                    ...
                    "19": ["rocket mount", "ROCKET_MOUNT", 3,
...
chassis_dict = {1: {"x": 2, "y": 5, "name": "mini_chassis", "front": 1, "armor_scale": 1.0},
                ...
                4: {"x": 8, "y": 10, "name": "large_chassis", "front": 4, "armor_scale": 1.3}}

turret_dict = {0: {"x": 0, "y": 0, "name": "no_turret", "block_x": 0, "block_y": 0, "armor_scale": 0},
               1: {"x": 2, "y": 2, "name": "mini_turret", "block_x": 2, "block_y": 1, "armor_scale": 1.0},
               2: {"x": 2, "y": 3, "name": "small_turret", "block_x": 2, "block_y": 2, "armor_scale": 1.1},
               3: {"x": 4, "y": 3, "name": "medium_turret", "block_x": 4, "block_y": 2, "armor_scale": 1.2},
               4: {"x": 5, "y": 4, "name": "large_turret", "block_x": 4, "block_y": 3, "armor_scale": 1.3},
               5: {"x": 8, "y": 5, "name": "huge_turret", "block_x": 6, "block_y": 4, "armor_scale": 1.4}}
